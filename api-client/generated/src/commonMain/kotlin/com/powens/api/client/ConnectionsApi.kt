...
open class ConnectionsApi : ApiClient {
    ...
    open suspend fun createUserConnection(connectionRequest: ConnectionRequest, expand: kotlin.collections.List<ExpandCreateUserConnection>? = null, source: kotlin.String? = null): HttpResponse<Connection> {
     ...
     */
    @Serializable
    enum class ExpandDeleteUserConnection(val value: kotlin.String) {
     ...
     * @return void
     */
    open suspend fun deleteUserConnection(connectionId: kotlin.Long, expand: kotlin.collections.List<ExpandDeleteUserConnection>? = null): HttpResponse<Unit> {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun updateSyncUserConnection(connectionId: kotlin.Long, expand: kotlin.collections.List<ExpandUpdateSyncUserConnection>? = null, source: kotlin.String? = null, background: kotlin.Boolean? = null, connectionUpdateRequest: ConnectionUpdateRequest? = null): HttpResponse<Connection> {
