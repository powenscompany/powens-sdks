 ...
 * @param type Type of the loan: * `mortgage`: Mortgage * `consumercredit`: Consumer credit * `revolvingcredit`: Revolving credit 
 */
@Serializable
...
data class Loan (
    ...
    @SerialName(value = "type") val type: Loan.Type? = null
    ...
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "mortgage") Mortgage("mortgage"),
        @SerialName(value = "consumercredit") ConsumerCredit("consumercredit"),
        @SerialName(value = "revolvingcredit") RevolvingCredit("revolvingcredit");
    }
}
